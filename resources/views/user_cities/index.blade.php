            ...
            <div class="bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form action="{{ route('user_cities.store') }}" method="POST" class="mb-8">
                    ...
                    <div class="flex">
                        ...
                        <button type="submit"
                            class="bg-blue-600 text-black font-bold px-6 py-3 rounded-r-md hover:bg-blue-700 transition duration-300 ease-in-out">
                            Add City
                        </button>
                    </div>
                </form>
                            ...
                            <div class="p-4 flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('user_cities.toggle_favorite', $favoriteCity) }}" method="POST">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                            class="text-yellow-500 hover:text-yellow-400 transition duration-300">
                                    ...
                                    <form action="{{ route('user_cities.toggle_forecast', $favoriteCity) }}" method="POST">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                            class="text-{{ $favoriteCity->send_forecast ? 'emerald' : 'blue' }}-500 hover:text-{{ $favoriteCity->send_forecast ? 'emerald' : 'blue' }}-400 transition duration-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="p-4 flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('user_cities.toggle_favorite', $city) }}" method="POST">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                            class="text-blue-500 hover:text-yellow-500 transition duration-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                                    ...
                                    <form action="{{ route('user_cities.toggle_forecast', $city) }}" method="POST">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                            class="text-{{ $city->send_forecast ? 'emerald' : 'blue' }}-500 hover:text-{{ $city->send_forecast ? 'emerald' : 'blue' }}-400 transition duration-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
